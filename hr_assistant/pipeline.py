...
def ask(agent, question: str) -> str:
    ...
    # Intercept greeting "hii" (case-insensitive, ignoring trailing punctuation/spaces)
    if question.strip().lower().rstrip("?.!") == "hii":
        return "HR Policy Assistant: How can I assist you?"
